...
do
    ...
    python3 gate_obfuscation_NAND_NOR.py --input_path ./BENCH/ --lockout ./results/${bench_name}/temp --percent 5 --test_files b14_C_syn.bench --dataset_dir ./dataset/ --obsout ./obfuscated_files/
    export trial=$trial
